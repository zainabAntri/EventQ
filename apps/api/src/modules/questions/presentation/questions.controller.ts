...
export class QuestionsController {
  ...
  @ApiOperation({
    ...
    description:
      'Cursor-paginated, newest first. Includes the flags explaining why the system held or quarantined a question. Returns an empty page for an event owned by another organization — identical to one with no questions, so ids cannot be probed.',
  })
